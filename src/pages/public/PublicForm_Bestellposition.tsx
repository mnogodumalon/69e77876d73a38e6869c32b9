...
const PROXY_BASE = '';
const APP_ID = '69e778613af3af4f8fbc0827';
...
export default function PublicFormBestellposition() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Bestellposition — Formular</h1>
        </div>
